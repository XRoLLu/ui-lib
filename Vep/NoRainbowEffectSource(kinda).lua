...
Library.Name = "STUPID TRASH VEP LIB THAT I EDITED FOR BECOME BEUTIFUL... kinda lol"
...
function VLib:Window(textgame, MAINTTL)
	...
	RainbowLine.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
	...
	function Tabs:Tab(text)
		...
		function ContainerItems:Toggle(text, callback)
			...
			ToggleFrameRainbowCorner.CornerRadius = UDim.new(0, 7)
			...
			ToggleDot.BackgroundColor3 = Color3.fromRGB(42, 42, 42)
		...
		function ContainerItems:Slider(text, min, max, start, callback) 
			...
			SliderIndicator.BackgroundColor3 = Color3.fromRGB(0, 162, 201)
		...
		function ContainerItems:Line()
			...
			Label2.BackgroundColor3 = Color3.fromRGB(32, 33, 37)
			Label2.Size = UDim2.new(0, 403, 0, 5)
			...
			LabelCorner2.CornerRadius = UDim.new(0, 6)
			LabelCorner2.Name = "LabelCorner"
