...
--nighmares.fun ui library edited
--u know i really like to edit a ui library
...
function Fun.Create(title)
    ...
    nightmares.Font = Enum.Font.SourceSans
    nightmares.Text = title
    nightmares.TextColor3 = Color3.fromRGB(255, 255, 255)
    nightmares.TextSize = 15.000
    ...
    function tabHandling:Tab(tabText)
        ...
        newPage.ScrollBarImageColor3 = Color3.fromRGB(255, 255, 255)
        ...
        function sectionHandling:Section(sectionName)
            ...
            function itemHandling:Button(btnText, callback)
                ...
                TextButton.BackgroundColor3 = Color3.fromRGB(19, 114, 156)
                ...
                TextButton.MouseEnter:Connect(function()
                    if callBackDebounce then
                        mouseleft = false
                        game.TweenService:Create(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),{
                            BackgroundColor3 = Color3.fromRGB(15, 100, 156)
                        }):Play()
                    else
                        mouseleft = false
                        game.TweenService:Create(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),{
                            BackgroundColor3 = Color3.fromRGB(19, 114, 156)
                        }):Play()
                    end
                end)
            ...
            function itemHandling:Toggle(togInfo, callback)
                ...
                checkBoxInfo.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                function itemHandling:TextBox(textInfo, callback)
                    ...
                    TextBox.Text = ""
                    TextBox.TextColor3 = Color3.fromRGB(0, 110, 210)
                ...
                function itemHandling:Slider(sliderInf, maxvalue, minvalue, callback)
                    ...
                    sliderIinfo.TextColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    SliderDrag.BackgroundColor3 = Color3.fromRGB(0, 110, 211)
                    SliderDrag.BorderColor3 = Color3.fromRGB(0, 110, 211)
                ...
                function itemHandling:MiddleLabel(txtLabel2)
                    txtLabel2 = txtLabel2 or "nightmare.fun"
                    local TextLabel = Instance.new("TextLabel")
                ...
                function itemHandling:Dropdown(dropInfo, list, callback)
                    ...
                    dropdownFrameHeader.BackgroundColor3 = Color3.fromRGB(3, 141, 255)
                    ...
                    dropcover.BackgroundColor3 = Color3.fromRGB(3, 141, 255)
