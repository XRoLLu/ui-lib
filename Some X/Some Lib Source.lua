	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text,ico)
			...
			function ChannelContent:Button(text, callback)
				...
				Button.MouseEnter:Connect(function()
					TweenService:Create(
						Button,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = PresetColor, TextColor3 = Color3.fromRGB(41, 41, 41)}
					):Play()
				end)
				...
				Button.MouseLeave:Connect(function()
					TweenService:Create(
						Button,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(41, 41, 41), TextColor3 = PresetColor}
					):Play()
				end)
            ...
            function ChannelContent:Toggle(text, default, callback)
				...
				local ToggleOutlineCorner = Instance.new("UICorner")
				...
				ToggleOutlineCorner.CornerRadius = UDim.new(0, 7)
                ToggleOutlineCorner.Name = "ToggleOutlineCorner"
                ToggleOutlineCorner.Parent = Toggle
                ...
                ToggleFrameOutlineCorner.CornerRadius = UDim.new(0, 7)
                ...
                ToggleFrameCorner.CornerRadius = UDim.new(0, 7)
                ToggleFrameCorner.Name = "ToggleFrameCorner"
                ToggleFrameCorner.Parent = ToggleFrame

                ToggleFrameCircle.Name = "ToggleFrameCircle"
                ToggleFrameCircle.Parent = ToggleFrame
                ToggleFrameCircle.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
                ToggleFrameCircle.Position = UDim2.new(0.234999999, -5, 0.133000001, 0)
                ToggleFrameCircle.Size = UDim2.new(0, 15, 0, 15)

                ToggleFrameCircleCorner.CornerRadius = UDim.new(0, 5)
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownFrameMain.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
