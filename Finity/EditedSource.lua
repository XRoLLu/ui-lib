...
finity.dark_theme = {
	main_container = Color3.fromRGB(33, 16, 41),
	separator_color = Color3.fromRGB(33, 16, 41),
	...
	checkbox_outer = Color3.fromRGB(0, 23, 48),
	checkbox_inner = Color3.fromRGB(0, 23, 48),
