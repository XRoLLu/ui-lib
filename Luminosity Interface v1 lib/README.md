# Luminostity Interface V1 Example

have to delete some little bit of the example cuz most of them have error
```Lua
...
Folder.Slider("Slider", {Precise = true, Default = 18, Min = 10, Max = 125}, function(Status)
