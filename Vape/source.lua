...
function lib:Window(text, preset, closebind)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:AddSeperator()
            local Seperator = Instance.new("TextButton")
            local SeperatorCorner = Instance.new("UICorner")

            Seperator.Name = "Seperator"
            Seperator.Parent = Tab
            Seperator.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
            Seperator.Size = UDim2.new(0, 363, 0, 10)
            Seperator.AutoButtonColor = false
            Seperator.Font = Enum.Font.SourceSans
            Seperator.Text = ""
            Seperator.TextColor3 = Color3.fromRGB(0, 0, 0)
            Seperator.TextSize = 14.000

            SeperatorCorner.CornerRadius = UDim.new(0, 5)
